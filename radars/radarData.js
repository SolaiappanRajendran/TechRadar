...
document.title = "SGM Technology Radar";

//This is the concentic circles that want on your radar
var radar_arcs = [
    {'r': 100, 'name': 'Maintain', color: '#bfc0bf'}
    ,
    {'r': 200, 'name': 'Invest', color: '#cbcccb'}
    ,
    {'r': 300, 'name': 'Watch', color: '#d7d8d6'}
    ,
    {'r': 400, 'name': 'Exit', color: '#e4e5e4'}
